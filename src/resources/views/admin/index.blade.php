...
<div class="content-area">
    ...
    <table border="1">
        ...
        @forelse ($currentEmployeeLoans as $currentEmployeeLoan)

        <tr>
            <td>{{ $loop->iteration }}</td>
            <td>{{ $currentEmployeeLoan->asset_name }}</td>
            <td>{{ $currentEmployeeLoan->category_name }}</td>
            <td>貸出資産</td>
            <td>{{ $currentEmployeeLoan->loan_date }}</td>
            <td>{{ $currentEmployeeLoan->due_date }}</td>

            <td>
                @if ($currentEmployeeLoan->due_date < today())
                    期限超過
                @else
                    貸出中
                @endif
