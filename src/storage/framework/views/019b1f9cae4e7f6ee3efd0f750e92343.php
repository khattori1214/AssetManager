...
<div class="content-area">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="cancel-button"
                        onclick="openDeleteModal('<?php echo e($asset->asset_id); ?>', '<?php echo e($asset->asset_name); ?>')">
                        削除する
                    </button>
                </td>
            </tr>
    ...
    <table border="1">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $currentEmployeeLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currentEmployeeLoan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

        <tr>
            <td><?php echo e($loop->iteration); ?></td>
            <td><?php echo e($currentEmployeeLoan->asset_name); ?></td>
            <td><?php echo e($currentEmployeeLoan->category_name); ?></td>
            <td>貸出資産</td>
            <td><?php echo e($currentEmployeeLoan->loan_date); ?></td>
            <td><?php echo e($currentEmployeeLoan->due_date); ?></td>

            <td>
                <?php if($currentEmployeeLoan->due_date < today()): ?>
                    期限超過
                <?php else: ?>
                    貸出中
                <?php endif; ?>
